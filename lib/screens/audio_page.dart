...
class _AudioPageState extends State<AudioPage> {
  ...
  downloadFile(String downloadLink) async {
    ...
    String? path =  await downloadNotifier.downloadMaterial(storageIO: storageIO,downloadLink: widget.material.filePath,fileName: widget.material.fileName);
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      downloadNotifier.downloads.containsKey(widget.material.fileName) ? ConstrainedBox(
                        constraints: const BoxConstraints(maxWidth: 20,maxHeight: 10),
                        child: Padding(
                          padding: const EdgeInsets.symmetric(vertical:18.0),
                          child: CircularProgressIndicator(
                            value: (downloadNotifier.downloads[widget.material.fileName]["progress"]) / 100,
                            strokeWidth: 3,
                            color: Colors.white,
                          ),
                        )): Padding(
                          ...
                          child: IconButton(
                            ...
                            icon: Icon(
                              widget.material.isLocal? Icons.check_circle_rounded :Icons.cloud_download_rounded,
                              size: 20,
                              color: Colors.white,
                            )),
                        ),
                  ...
                  children: [
                    InkWell(
                      onTap: (){
                        ...
                        Duration seek = audioPlayer.position-const Duration(seconds: 10);
                      ...
                      child: Column(
                        children: [
                          LinearProgressIndicator(
                            ...
                            value: ((snapshot.data ?? Duration.zero).inSeconds/(audioPlayer.duration?? Duration.zero).inSeconds).clamp(0, 1),
                            minHeight: 10,
                          ),
                          const SizedBox(
                            height: 10,
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Text(
                                formatTime(audioPlayer.duration ?? Duration.zero),
                                style: Theme.of(context)
                                    .textTheme
                                    .bodySmall
                                    ?.copyWith(fontSize: 12),
